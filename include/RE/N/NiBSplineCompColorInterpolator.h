...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiBSplineCompColorInterpolator;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiBSplineCompColorInterpolator;

		~NiBSplineCompColorInterpolator() override = default;  // 00
	...
	static_assert(sizeof(NiBSplineCompColorInterpolator) == 0x50);
}
