...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiBSplineCompPoint3Interpolator;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiBSplineCompPoint3Interpolator;

		~NiBSplineCompPoint3Interpolator() override = default;  // 00
	...
	static_assert(sizeof(NiBSplineCompPoint3Interpolator) == 0x48);
}
