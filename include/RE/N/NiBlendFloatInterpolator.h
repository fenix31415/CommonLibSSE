...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiBlendFloatInterpolator;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiBlendFloatInterpolator;

		~NiBlendFloatInterpolator() override = default;  // 00
	...
	static_assert(sizeof(NiBlendFloatInterpolator) == 0x50);
}
