...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_BSRotAccumTransfInterpolator;
		inline static constexpr auto Ni_RTTI = NiRTTI_BSRotAccumTransfInterpolator;

		~BSRotAccumTransfInterpolator() override = default;  // 00
	...
	static_assert(sizeof(BSRotAccumTransfInterpolator) == 0x50);
}
