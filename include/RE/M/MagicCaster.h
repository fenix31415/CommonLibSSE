...
namespace RE
{
	...
	public:
		...
		// add
		virtual void InstantCast(SpellItem* spell, bool noHitEffectArt, Actor* target, float effectiveness, bool hostileEffectivenessOnly, float magnitudeOverride, Actor* cause);  // 1
